...
docker pull yeasy/hyperledger-fabric-base:$IMG_TAG \
  && docker pull jollen/hyperledger-fabric-peer:$IMG_TAG \
...
docker tag jollen/hyperledger-fabric-peer:$IMG_TAG hyperledger/fabric-peer \
  && docker tag jollen/hyperledger-fabric-peer:$IMG_TAG hyperledger/fabric-tools \
